<template>
    <IonItem :button="true" lines="none">
      ...
      <IonLabel>
        <p>
          <IonText color="dark">{{ credit?.business?.name }} Racy Venured paid-  </IonText>
          <IonText color="medium">GHS {{ credit?.total_sales_price }} 1234</IonText>
        </p>
        <p class="font-medium">
        ...
        <p>
          <IonText color="medium"  class="font-medium">paid via mobile money  </IonText>
        </p>
      </IonLabel>
      <IonButton
        v-if="popover"
