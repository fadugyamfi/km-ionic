<template>
    <IonModal :isOpen="isOpen" id="remove-role-modal" ref="modal">
      <div class="wrapper ion-padding">
        <div class="ion-text-center">
          ...
          <h6 class="fw-semibold">
            {{ $t("profile.team.removeRole?") }}
          </h6>
          <p>
            <IonText color="muted">
              {{ $t("profile.team.youCanAlwaysAddRole") }}
            </IonText>
          </p>
        </div>
  ...
  ion-modal#remove-role-modal h6 {
    margin: 20px 20px 10px 20px;
    color: var(--gray-900, #101828);
  }
  
  ion-modal#remove-role-modal ion-icon {
    margin-right: 6px;
    width: 18px;
    height: 28px;
    padding: 4px 0;
  ...
  ion-modal#remove-role-modal .wrapper {
    margin-bottom: 10px;
  }
  
  ion-modal#remove-role-modal .wrapper p {
    margin-bottom: 1.8em;
    margin-top: 0.25em;
