<template>
  <IonTabBar slot="bottom" id="shopperTabs">
    <IonTabButton tab="tab1" href="/shopper/home">
      ...
      <img
        class="active"
        src="/images/navigation/home_active.svg"
        loading="lazy"
        width="25"
        height="25"
      />
    ...
    <IonTabButton tab="tab2" href="/shopper/orders">
      ...
      <img
        class="active"
        src="/images/navigation/orders_active.svg"
        loading="lazy"
        width="25"
        height="25"
      />
    ...
    <IonTabButton tab="tab3" class="cartTab has-badge" :href="cartRoute">
      <img src="/images/navigation/cart.svg" width="25" height="25" />
      <img
        class="active"
        src="/images/navigation/cart_active.svg"
        loading="lazy"
        width="25"
        height="25"
      />
    ...
    <IonTabButton tab="tab5" href="/shopper/profile" class="has-badge small">
      ...
      <img
        src="/images/navigation/profile_active.svg"
        loading="lazy"
        width="25"
        height="25"
        class="active"
...
export default defineComponent({
  ...
  computed: {
    ...mapStores(useCartStore, useOrderStore, useAppStore, useCartStore),

    cartRoute() {
      if (this.cartStore.orders?.length == 1) {
        return `/shopper/cart/business/${this.cartStore.orders[0]?.businesses_id}/orders`;
      }
      return "/shopper/cart/business";
    },
  },
});
</script>
