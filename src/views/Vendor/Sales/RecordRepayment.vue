    ...
    <IonPage>
        <IonHeader class="ion-padding ion-no-border">
            <IonHeader class="inner-header ion-margin-bottom">
                <IonToolbar>
                    ...
                    <IonTitle size="small"><b>{{ $t("vendor.sales.recordRepayment") }}</b></IonTitle>
                    <IonButtons slot="end">
        ...
        <IonContent class="ion-padding-horizontal">
            <form @submit.prevent="addPayment()">
                <p class="fw-semibold" style="margin-bottom: 0.25em;">{{ $t('vendor.sales.amountPaid') }}</p>
                <IonInput
                ...
                <p class="fw-semibold" style="margin-bottom: 0.25em;">{{ $t('vendor.sales.addDate') }}</p>
                <IonInput
                    class="kola-input ion-margin-bottom"
                    :class="{
                ...
                <IonList lines="none" class="sales-select-list">
                    <IonListHeader class="d-flex flex-column ion-align-items-start ion-margin-bottom">
...
<script lang="ts">
import { IonBackButton, IonButton, IonButtons, IonCheckbox, IonContent, IonFooter, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonList, IonListHeader, IonPage, IonSpinner, IonText, IonTitle, IonToolbar } from '@ionic/vue';
...
export default defineComponent({
    ...
    IonTitle, IonButton, IonIcon, IonContent, IonFooter,
    KolaYellowButton, IonInput,
    IonText,
    IonList,
    IonListHeader,
    IonLabel,
    ...
    methods: {
        ...
        formValid() {
            return this.form.fields.amount > 0
                && this.form.fields.payment_date != null && this.form.fields.payment_date.length > 0
        ...
        async addPayment() {
            ...
            try {
                ...
                if( response ) {
                    toastStore.showSuccess( this.$t('vendor.sales.paymentRecordedSuccessfully') )
