            ...
            <form method="post" ref="form" @submit.prevent="onContinue()">
                <main>
                    ...
                    <IonSelect
                        ...
                        :class="{ 'ion-invalid ion-touched': form.errors.primary_product_category_id }"
                        labelPlacement="stacked"
                        fill="solid"
                    ...
                    >
                        <IonSelectOption v-for="category in productCategoryStore.categories" :key="category.id" :value="category.id">
                            {{ category.name }}
                        </IonSelectOption>
                    </IonSelect>
                    ...
                    <IonSelect
                        ...
                        @ion-change="form.validateSelectInput($event)"
                    >
                        <IonSelectOption v-for="country in countries" :key="country.id" :value="country.id">
                            {{ country.name }}
                        </IonSelectOption>
                    </IonSelect>
                    ...
                    <IonInput
                        class="kola-input ion-margin-bottom"
                        :class="{ 'ion-invalid ion-touched': form.errors.number_of_products }"
                    ...
                    <IonInput
                        class="kola-input ion-margin-bottom"
                        :class="{ 'ion-invalid ion-touched': form.errors.how_you_heard_about_kola }"
                        :label="$t('signup.vendor.howDidYouHearAboutUs')"
                        labelPlacement="stacked"
                        fill="solid"
                        v-model="businessStore.registration.attributes.how_you_heard_about_kola"
                        required
...
<script lang="ts">
import { IonBackButton, IonButton, IonButtons, IonCard, IonCardContent, IonContent, IonFooter, IonHeader, IonInput, IonPage, IonSelect, IonSelectOption, IonTitle, IonToolbar } from '@ionic/vue';
