        ...
        <ion-content>
            ...
            <main>
                ...
                <section class="section arrival-section">
                    <GuestBrandNewArrival :brand="brand"></GuestBrandNewArrival>
                </section>
            </main>
        </ion-content>
    </ion-page>
...
import GuestBrandNewArrival from '@/components/modules/brands/GuestBrandNewArrival.vue';
