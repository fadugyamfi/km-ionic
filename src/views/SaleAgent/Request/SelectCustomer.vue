  ...
  <IonPage>
      ...
      <IonHeader classs="ion-no-border" style="box-shadow: none">
        <IonHeader class="inner-header">
          <IonToolbar>
            ...
            <IonTitle size="small"
              ><b>{{ $t("vendor.sales.selectCustomer") }}</b></IonTitle
            >
            <IonButtons slot="end">
        ...
        >
          ...
          >
            ...
            <IonCheckbox
              ...
              mode="ios"
              :value="customer.id"
              :checked="requestStore.newRequest.customer_id == customer.id"
            ></IonCheckbox>
          </IonItem>
        </IonList>
      </section>
    ...
    <IonFooter class="ion-padding ion-no-border">
      <KolaYellowButton
        ...
        :disabled="!requestStore.newRequest.customer_id"
        @click="onContinue()"
      >
        {{ $t("general.continue") }}
      </KolaYellowButton>
...
export default defineComponent({
  ...
  methods: {
    ...
    selectCustomer(customer: Business) {
      this.requestStore.newRequest.customer_id = customer.id as number;
      this.requestStore.selectedCustomer = customer;
    },

    onContinue() {
      if (!this.requestStore.newRequest.customer_id) {
