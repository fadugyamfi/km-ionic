<template>
  <section>
    ...
    <section v-else>
      <section class="shopper-home-section ion-padding-top" v-for="promotion in promotions"
        :key="promotion.id"
        :promotion="promotion">
...
export default defineComponent({
  ...
  components: { Swiper, SwiperSlide, IonText, ProductCard, IonButton, IonSpinner, IonSkeletonText, ProductsLoadingSkeletons },
